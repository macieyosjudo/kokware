...
export default function Home() {
  return (
    <div>
      {/* ===== HERO ===== */}
      <section className="relative flex items-center overflow-hidden bg-gradient-to-br from-brand-50 via-white to-cyan-50 pt-16" aria-label="Strona główna">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-2 gap-2 sm:gap-12 items-center">
            ...
            <div className="order-1 lg:order-1">
              ...
              <motion.h1
                ...
                className="text-3xl sm:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-gray-900 mb-3 sm:mb-6"
              >
                Uśmiech godny{' '}
            ...
            >
              <div className="w-56 sm:w-48 lg:w-[300px]">
                <DentistSVG />
              </div>
            </motion.div>
          </div>
